...
<?php if($logged_in['uacc_group_fk'] == '3'){ ?>
<div class="row" style="margin-bottom: 10px;">
    <div class="col-md-12">
        <a href="javascript:;" class="btn blue" onclick="open_modal_add_user();"><i class="fa fa-plus"></i> TAMBAH PELAJAR </a>
    </div>
</div>
<?php } ?>
...
<div class="modal fade" tabindex="-1" role="dialog" id="modal_add_new_user" data-width="760">
	<div class="modal-content">
        <div class="modal-header">
	       ...
	       <h4 class="modal-title">TAMBAH PELAJAR</h4>
	   </div>
...
function open_modal_add_user(){
    blockUI();
    $("#modal_add_new_user_body").load("<?php echo base_url(); ?>users/modal_add_new_student", function(){
    ...
    datatable_el = $('#example').DataTable( {
        ...
        "columns": [
            ...
            { "data": "uacc_id", "render": function ( data, type, row ) {
                ...
                html += '<a href="<?php echo base_url(); ?>users/admin_view_student_detail/?page=user_profile&u='+row.uacc_id+'" class="btn btn-sm green"><i class="fa fa-search"></i> LIHAT</a>';
...
function force_change_password(uacc_id, uacc_username){
    swal({
        ...
        html: true,
        text: "SET SEMULA KATA LALUAN UNTUK <br><b>"+uacc_username+"</b>",
        type: "warning",
...
function quick_delete(uacc_id){
    swal({
        title: "ADAKAH ANDA PASTI?",
        text: "TINDAKAN INI TIDAK BOLEH DIULANG",
        type: "warning",
        showCancelButton: true,
        confirmButtonColor: "#DD6B55",
    ...
    function(){
        $.ajax({
            ...
            success: function(data){
                if(data.status == "success"){
                    datatable_el.ajax.reload(function(){
                        swal("BERJAYA!", "PELAJAR BERJAYA DIPADAMKAN", "success");
                    });
                } else {
                    sweetAlert("Oops...", "Something went wrong!", "error");
                }
