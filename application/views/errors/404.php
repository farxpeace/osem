...
<html lang="en">
  <head>
    ...
    <!-- Core CSS -->
    <link href="<?php echo base_url(); ?>assets/global/css/404.css" rel="stylesheet">
	...
	<body class="dusk">
				...
				<div class="message">
						...
						<div class="btndiv"><a href="<?php echo base_url(); ?>"><button class="btnpop">Go to Home</button><a></div>						
				</div>
				</div>
				<div id='stars1'></div>
				<div id='stars2'></div>
