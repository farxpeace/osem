        ...
        <div class="tf-container">
            <div class="tf-topbar d-flex justify-content-between align-items-center">
                <a class="user-info d-flex justify-content-between align-items-center" href="<?php echo base_url(); ?>profile/view_profile/">
                    <img src="<?php echo $logged_in['user_profile']['profile_picture_url'] ?>" alt="image" style="border: 1px solid #ffffff;">
                    <div class="content">
                        <h4 class="white_color" style="font-size: 0.9rem !important; line-height: 0.6rem !important;"><?php echo $logged_in['user_profile']['fullname'] ? $logged_in['user_profile']['fullname'] : "User" ?></h4>
                        <p class="white_color fw_4"><?php echo $logged_in['uacc_username'] ?></p>
                    </div>
                </a>
            </div>
        </div>
...
<div class="tf-container mt-5">
    <div class="card card-bordered">
        <div class="card-inner">
            <h4 class="card-title mb-1" style="font-size: 1rem">Leads</h4>
            <ul class="box-service mt-3" style="grid-template-columns: repeat(2, 1fr);">
                <li>
                    <a href="/leads/add_new_leads/">
                        <div class="icon-box">
    ...
    <?php if($logged_in['is_admin'] == "yes"){ ?>
        <div class="card card-bordered">
            <div class="card-inner">
                <h4 class="card-title mb-1" style="font-size: 1rem">Administrator</h4>
                <ul class="box-service mt-3" style="grid-template-columns: repeat(3, 1fr);">
                    <li>
                        <a href="/leads/list_expired_leads/">
                            <div class="icon-box">
                                <img src="https://www.svgrepo.com/show/169364/bulb.svg" style="width: 40px" />
                            </div>
                            Expired Leads
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="/leads/admin_list_all_leads/">
                            <div class="icon-box">
                                <img src="https://www.svgrepo.com/show/299230/users-team.svg" style="width: 40px" />
                            </div>
                            All Leads
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="/agents/admin_list_all_agents/">
                            <div class="icon-box">
                                <img src="https://www.svgrepo.com/show/211003/users-user.svg" style="width: 40px" />
                            </div>
                            All Agents
                        </a>
                    </li>
