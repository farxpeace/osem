                ...
                <div class="card-inner">
                    <div class="card-title-group mb-2">
                        <div class="card-title">
                            <h6 class="title">Score Report Stats</h6>
                        </div>
                    </div>
                    <ul class="nk-store-statistics">
                        <li class="item">
                            <div class="info">
                                ...
                                <div class="count"><?php echo $this->far_dashboard->count_score_report_pending_staff($logged_in['uacc_id']); ?></div>
                            </div>
                        ...
                        <li class="item">
                            <div class="info">
                                ...
                                <div class="count"><?php echo $this->far_dashboard->count_score_report_completed_staff($logged_in['uacc_id']); ?></div>
                            </div>
