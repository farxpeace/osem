...
<div class="clearfix" style="margin-bottom: 20px;">
    <a href="javascript: void(0);" onclick="javascript: modal_add_new_designation();" class="btn green">
         Add New Job Title <i class="fa fa-plus"></i>
    </a>
</div>
        ...
        <div class="row">
            <div class="col-md-12 form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" placeholder="JOB TITLE" id="add_user_designation_name" />
        ...
        <div class="row">
            <div class="col-md-12 form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" placeholder="Enter NAME" id="edit_user_designation_name"/>
                        <span class="help-block error_message" style="display: none;"></span>
                    </div>
                </div>
                ...
                <input hidden="" id="edit_user_designation_id" />
...
function quick_edit(user_designation_id){
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            Metronic.unblockUI();
            $("#edit_user_designation_id").val(data.user_designation_id);
            $("#edit_user_designation_name").val(data.user_designation_name);
...
$(function(){
    ...
    datatable_el = $('#example').DataTable( {
        ...
        "serverSide": true,
        "ajax": {
            "url": "<?php echo base_url(); ?>settings/ajax_dt_list_designation",
            "type": "POST"
        },
        "lengthMenu": [[10, 20, 50, -1], [10, 20, 50, "All"]],
        "columns": [
            { "data": "user_designation_id" },
            { "data": "user_designation_name" },
            
            { "data": "user_designation_id", "render": function ( data, type, row ) {
                redited = '';
                ...
                redited += '<a href="javascript: void(0);" onclick="javascript: quick_delete(\''+row.user_designation_id+'\');" class="btn btn-xs red"><i class="fa fa-times"></i></a>'
                redited += '<a href="javascript: void(0);" onclick="javascript: quick_edit(\''+row.user_designation_id+'\');" class="btn btn-xs blue"><i class="fa fa-pencil"></i></a>'
                return redited
            } },
        ],
        "order": [0, 'desc']
...
<script type="text/javascript">
function quick_delete(user_designation_id){
    swal({
        title: "Are you sure?",
    ...
    function(){
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>settings/ajax_admin_delete_designation",
            type: "POST",
            dataType: "json",
            data: {
                postdata: {
            ...
            success: function(data){
                if(data.status == "success"){
                    datatable_el.ajax.reload(function(){
                        swal("Deleted!", "Job Title has been deleted successfully", "success");
                    });
                } else {
...
function btn_add_new_designation(){
    ...
    var add_user_designation_name = $("#add_user_designation_name").val();
    ...
    $.ajax({
        url: '<?php echo base_url(); ?>settings/ajax_admin_add_new_designation',
        type: 'POST',
        dataType: 'json',
        data: { 
            postdata: { 
                add_user_designation_name: add_user_designation_name
            } 
        },
        success: function(data){
            ...
            if(data.status == "success"){
                ...
                swal({
                    title: "Success!",
                    text: "New Job Title has been added",
                    type: "success",
                    closeOnConfirm: true
                },
                function(){
...
function btn_edit_type(){
    ...
    var edit_user_designation_name = $("#edit_user_designation_name").val();
    var edit_ob_scope_of_work_registration_number = $("#edit_ob_scope_of_work_registration_number").val();
    var edit_user_designation_id = $("#edit_user_designation_id").val();
    ...
    $.ajax({
        ...
        data: { 
            postdata: { 
                edit_user_designation_name: edit_user_designation_name,
                edit_ob_scope_of_work_registration_number: edit_ob_scope_of_work_registration_number,
                edit_user_designation_id: edit_user_designation_id
            } 
        },
        success: function(data){
            ...
            if(data.status == "success"){
                ...
                swal({
                    title: "Success!",
                    text: "Job Title successfully updated",
                    type: "success",
                    closeOnConfirm: true
                },
                function(){
