...
<div id="app-wrap">
    ...
    <pre><?php //var_dump($this->far_attendance->is_already_clockout_by_date($logged_in['uacc_id'],$filter_date)); ?></pre>
    ...
    <div class="bottom-navigation-bar st1 bottom-btn-fixed col-md-4 offset-md-4" style="margin: 0 auto;">
        <div class="tf-container" style="display: flex; justify-content: space-between; gap: 10px;">
            <a href="javascript: void(0);" onclick="javascript: navigate_to('back');" id="btn-popup-up" class="tf-btn accent large"><i class="fa-solid fa-angle-left"></i> Back to History</a>
        </div>
    </div>
</div>
